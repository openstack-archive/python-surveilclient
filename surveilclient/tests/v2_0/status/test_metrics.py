...
class TestMetrics(clienttest.ClientTest):
    ...
    def test_list(self):
        ...
        metrics = self.client.status.metrics.list('localhost', 'load1',
    ...
    def test_show(self):
        ...
        metrics = self.client.status.metrics.get('localhost', 'load1')
    ...
    def test_show_service(self):
        ...
        metrics = self.client.status.metrics.get('localhost', 'load1', 'load')
