...
@cliutils.arg("host_name_origin", help="Original name of the host")
...
def do_config_host_update(sc, args):
    ...
    sc.config.hosts.update(args.host_name_origin, **host)
...
@cliutils.arg("command_name_origin", help="Original name of the command")
...
def do_config_command_update(sc, args):
    ...
    arg_names = ['command_name',
                 'command_line']
    command = _dict_from_args(args, arg_names)
    sc.config.commands.update(args.command_name_origin, **command)
